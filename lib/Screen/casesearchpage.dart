...
class CaseSearchPage extends StatefulWidget {
  @override
  _CaseSearchPageState createState() => _CaseSearchPageState();
}

class _CaseSearchPageState extends StateMVC<CaseSearchPage> {
  late FunctionController function;
  _CaseSearchPageState() : super(FunctionController()) {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: listofcasedata.length != 0
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return SearchCaseWidge(casedata: casedata);
                            },
                          )
                ...
                //     ),
                //     Text(
                //       'আপনার তালিকায় কোন মামলা নেই ।',
                //       style:
                //           TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                //     ),
                //     Text(
                //       'যে মামলা গুলো  করতে চান সেগুলো তালিকা যুক্ত করুন ।',
                //       style:
                //           TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                //     ),
                //     Text(
