...
class FreeDateUpdatePage extends StatefulWidget {
  var casedata;

  FreeDateUpdatePage(this.casedata);
  @override
  _AdminDateUpdatePageState createState() =>
      _AdminDateUpdatePageState(this.casedata);
}

class _AdminDateUpdatePageState extends StateMVC<FreeDateUpdatePage> {
  var casedata;
                            ...
                            child: RaisedButton(
                              onPressed: () {
                                if (getpicupdate == "") {
                                  ...
                                  function.freedatefunction(casedata,
