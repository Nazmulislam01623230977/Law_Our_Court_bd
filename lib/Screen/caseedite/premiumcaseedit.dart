...
class PremiumCaseEditPage extends StatefulWidget {
  // CaseEditPage({Key? key}) : super(key: key);
  var casedata;
  PremiumCaseEditPage(this.casedata);

  @override
  PremiumCaseEditPageState createState() =>
      PremiumCaseEditPageState(this.casedata);
}

class PremiumCaseEditPageState extends StateMVC<PremiumCaseEditPage> {
  var casedata;
  late FunctionController function;
  PremiumCaseEditPageState(this.casedata) : super(FunctionController()) {
